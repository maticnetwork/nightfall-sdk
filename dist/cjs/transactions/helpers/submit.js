 ...
 */
async function submitTransaction(senderEthAddress, senderEthPrivateKey, recipientEthAddress, unsignedTx, web3, value = "0") {
    logger.debug({ senderEthAddress, recipientEthAddress, unsignedTx, value }, "submitTransaction");
    // Estimate gas
